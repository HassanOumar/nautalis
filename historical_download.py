...
async def main(
    ...
    bars = await client.request_bars(
        ...
        start_date_time=datetime.datetime(2025, 1, 6, 9, 30),
        end_date_time=datetime.datetime(2025, 6, 6, 16, 30),
    ...
    trade_ticks = await client.request_ticks(
        "TRADES",
        start_date_time=datetime.datetime(2025, 1, 6, 10, 0),
        end_date_time=datetime.datetime(2025, 6, 6, 10, 1),
        tz_name="America/New_York",
        contracts=[contract],
        # instrument_ids=[instrument_ids],
    )
